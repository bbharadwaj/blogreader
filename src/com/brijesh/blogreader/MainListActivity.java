package com.brijesh.blogreader;
		...
		protected JSONObject doInBackground(Object... arg0) {
			...
			try{
				...
				if (responseCode == HttpURLConnection.HTTP_OK){
					...
					//once you have read it, get the content length
					int contentLength = connection.getContentLength();
					
					//create a char array of that length
					char[] charArray = new char[contentLength];
					
					//use the reader created to dump the data in the char array
					reader.read(charArray);
					
					//convert the charArray into a string
